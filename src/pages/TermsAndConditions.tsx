        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-8 md:p-12">
            ...
            <div className="prose prose-invert max-w-none text-white/80 space-y-6">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">User Representations</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">User Registration</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">Cancellation, Refunds, and Guarantees</h2>
                <p>
