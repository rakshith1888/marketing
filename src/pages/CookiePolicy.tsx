        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/20 rounded-2xl p-8">
            <div className="text-white/80 space-y-8 prose prose-invert max-w-none">
              <p>
                Thank you for choosing to be part of our community. We are committed to protecting your personal data and respecting your privacy rights. This cookie policy ("Policy") explains how personal data are collected through cookies and how cookies are used by Talent, Inc. and its subsidiaries and affiliates (collectively, "Company", "we", "us", or "our") when you access or use groflexerp.com, groflex.io, groflex.in, groflextech.com, media channel, mobile site or mobile application related, linked, or otherwise connected thereto (collectively, the "Platform").
              </p>
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li><strong>First-Party Cookies:</strong> these are Cookies which we place on our Site and which are only used by us.</li>
                <li><strong>Third-Party Cookies:</strong> Cookies that are placed on our Site by third parties. Examples of third parties are advertising partners or security providers.</li>
              </ul>

              <p>
                Certain Cookies may collect information that is or can be associated with personal data. Personal data is any information relating to an identified or identifiable natural person. You can find more information about the purposes for which we process your personal data in our Privacy Policy.
              </p>

              <p>
                If you have any questions or concerns about our collection or use of your information or the use of Cookies, please contact us at hello@groflexerp.com.
              </p>

              <h2 className="text-2xl font-bold text-white mt-12 mb-6">WHICH COOKIES DO WE USE?</h2>

              <p>
                We select our Cookies carefully. We work with certain third parties to collect data through Cookies, but we are neither responsible nor liable for the processing of personal data by these third parties, and can therefore not guarantee that these third parties will handle your personal data in a reliable and secure manner. You should always read the privacy and Cookie policies of other websites or tools before using them. If you want to know more about Cookies in general, please refer to the website all about Cookies.
              </p>
              ...
              <h3 className="text-xl font-semibold text-white mt-8 mb-4">ESSENTIAL COOKIES</h3>
              ...
              <h3 className="text-xl font-semibold text-white mt-8 mb-4">ANALYTICAL COOKIES</h3>
              ...
              <h3 className="text-xl font-semibold text-white mt-8 mb-4">MARKETING AND TRACKING COOKIES</h3>
              ...
              <h3 className="text-xl font-semibold text-white mt-8 mb-4">SOCIAL MEDIA BUTTONS</h3>
              ...
              <h2 className="text-2xl font-bold text-white mt-12 mb-6">HOW DO I FIND OUT THE EXACT COOKIES AND RETENTION PERIODS?</h2>

              <h3 className="text-xl font-semibold text-white mt-8 mb-4">Cookie check via any internet browser</h3>

              <ol className="list-decimal list-inside ml-4 space-y-1">
                <li>Press F12 or right-click on the page and select "inspect."</li>
                <li>Click on "Application."</li>
                <li>On the left side of the "inspect" frame, click on the "Cookies" option under "Storage." You may need to click on the URL address under "Cookies" to display how many cookies are set, the names and retention periods.</li>
              </ol>

              <h2 className="text-2xl font-bold text-white mt-12 mb-6">HOW CAN I CONTROL COOKIES?</h2>
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                ...
                <li>Cookie settings in Safari (OS X)</li>
                <li>Cookie settings in Safari (iOS)</li>
                <li>Cookie settings in Android</li>
              </ul>
              ...
              <p>
                You can submit requests for the exercise of your rights to us at hello@groflexerp.com.
              </p>

              <h2 className="text-2xl font-bold text-white mt-12 mb-6">DO WE MAKE UPDATES TO THIS POLICY?</h2>
