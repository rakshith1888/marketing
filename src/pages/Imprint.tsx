          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/20 rounded-2xl p-8">
            <div className="text-white/80 space-y-8 prose prose-invert max-w-none">
              ...
              <section>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="ml-4">Email: hello@groflexerp.com</p>
                  </div>
                  ...
                  <div>
                    <h4 className="text-lg font-medium text-white mb-2">Registration Details:</h4>
                    <div className="ml-4">
                      <p>Registered in California, USA</p>
                      <p>Tax Number: 38-427441</p>
                    </div>
                  </div>
              ...
              <section>
                ...
                <p>
                  We are not obliged to participate in dispute resolution proceedings before a consumer arbitration board. However, in case of any disputes, please contact us directly at hello@groflexerp.com, and we will do our best to resolve the issue amicably.
                </p>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-6">Copyright Infringement</h2>
                <p>
                  If you believe that any content on our website infringes upon your copyright, please notify us at info@groflextech.com. We will investigate and, if necessary, remove the infringing content promptly.
                </p>
                <p className="mt-4">
                  For any further information or inquiries, please contact us at info@groflextech.com.
                </p>
              </section>
              ...
              <section>
                ...
                <h3 className="text-xl font-semibold text-white mt-8 mb-4">Reporting Infringements:</h3>
                <p>
                  If you believe any image on our platform infringes upon your copyright or privacy rights, please contact us immediately at info@groflextech.com with the following information:
                </p>
                <ul className="list-disc list-inside ml-4 space-y-2 mt-4">
                  <li>A description of the copyrighted work or privacy right that you claim has been infringed.</li>
                  ...
                  <li>A statement by you, made under penalty of perjury, that the above information in your notice is accurate and that you are the copyright or privacy right owner or authorized to act on the owner's behalf.</li>
                </ul>
              </section>
